...
Item {
    ...
    var D =2*FILE.loadValue(file,"Circ4XYDialog/R",50);
    ...
    var Depth=MSCRIPT.getValue("WLProbeXYbaseZ",0)+sbDepth.value
    ...
    MSCRIPT.runScript("WLProbeFastDialog=1;WLProbeCirc4XYDialog()");
    }
    }
