...
private slots:
    void update(int n) {emit dataChanged(index(n,0),index(n,1));}
...
private slots:
    void updateOutPWM(int n) {emit dataChanged(index(n,0),index(n,3));}
...
private slots:
    void updateEncoder(int n) {emit dataChanged(index(n,0),index(n,0));}
...
private slots:
    ...
    void setDCTableEncoder(QModelIndex);
